...
def patch_file(path: Path, pattern: str, replacement: str, dry_run: bool = False) -> tuple[int, str]:
    """
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Synchronise la version Sovereign OS DIM depuis VERSION.")
    parser.add_argument(
        "--check",
        action="store_true",
