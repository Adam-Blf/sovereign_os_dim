...
LINE_FEATURES = [
    ...
    "feat_alpha_ratio",
    # Tokens HAD pos 0-2
    "feat_tok_had_starts_H",
    "feat_tok_had_H0X",
    "feat_tok_had_H1X",
    # Tokens MCO/SMR pos 9-11
    "feat_tok_starts_M",
    "feat_tok_starts_digit",
    "feat_tok_2digit_first",
    # Tokens PSY pos 18-20
    "feat_tok_psy_starts_P",
    "feat_tok_psy_P0X",
    "feat_tok_psy_P1X",
    # Tokens VID pos 48-51
    "feat_tok_vid_starts_V",
    "feat_tok_vid_starts_I",
    # Signatures structurelles
    "feat_double_finess_psy",
    "feat_leading_filler_10",
    # DDN signatures
    "feat_ddn_at_28_yyyy",
    "feat_ddn_at_41_yyyy",
    "feat_ddn_at_61_yyyy",
...
def _train_collision_risk(df: pd.DataFrame, out_dir: str) -> dict[str, Any]:
    return _train_binary(df, out_dir, "label_collision", MPI_FEATURES, "collision_risk", use_pos_weight=True)


def _train_ddn_validity(df: pd.DataFrame, out_dir: str) -> dict[str, Any]:
    return _train_binary(df, out_dir, "label_ddn_valid", LINE_FEATURES, "ddn_validity", use_pos_weight=False)
