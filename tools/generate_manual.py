...
SECTIONS = [
    ...
    (
        ...
        [
            (
                "p",
                "Sovereign OS DIM automatise quatre taches repetitives du quotidien d'un TIM :",
            ),
            (
                "li",
                [
        ...
        [
            ...
            (
                ...
                [
                    ...
                    "Identitovigilance : liste des collisions IPP / DDN et outil de resolution.",
                    "PMSI Pilot CSV : export CSV normalise pour e-PMSI.",
                    "Import CSV : lecture d'un CSV externe (cas d'usage annexe).",
                    "Tutoriel : rappel des gestes principaux, accessible hors ligne.",
                ],
            ),
            (
                "p",
        ...
        [
            (
                ...
                [
                    ...
                    "Theme sombre : bouton en haut a droite, bascule immediate et persistante.",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Genere le mode d'emploi PDF (fpdf2).")
    parser.add_argument(
        "--output",
